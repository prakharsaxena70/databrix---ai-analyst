...
import { Loader2, Eye, EyeOff, Mail, Lock, Sparkles, UserCheck } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleGuestLogin = async () => {
    ...
    try {
      await login("guest@databrix.ai", "guest123");
      router.push("/app");
    } catch (err) {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0f1117] relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm">Sign in to access your project workspace</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-14 pl-12 rounded-xl bg-white/5 border-white/10 text-white placeholder:text-slate-600 focus:border-indigo-500 focus:ring-indigo-500/20 transition-all font-medium"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-14 pl-12 pr-12 rounded-xl bg-white/5 border-white/10 text-white placeholder:text-slate-600 focus:border-indigo-500 focus:ring-indigo-500/20 transition-all font-medium"
                  required
                />
                <button
                  type="button"
            ...
            <div className="space-y-3">
              <Button
                ...
                className="w-full h-14 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 text-white font-bold text-base transition-all shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 active:scale-[0.98]"
              >
              ...
              <div className="relative py-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#1a1d24] px-4 text-slate-500 font-bold tracking-widest">Or</span>
                </div>
              </div>
              ...
              <Button
                ...
                disabled={isLoading || isGuestLoading}
                className="w-full h-14 rounded-xl border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/10 text-emerald-400 hover:text-emerald-300 font-bold text-base transition-all group active:scale-[0.98]"
              >
                {isGuestLoading ? (
